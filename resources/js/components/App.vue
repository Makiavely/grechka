        ...
        <div class="flex">
            ...
            <div class="pl-6 bg-gray-200 w-48 h-screen border-r-2 border-gray-400">
                <nav class="pt-4">
                    ...
                    <router-link to="/products" class="flex items-center py-2 hover:text-blue-600 text-sm">
                        ...
                        <div class="tracking-wide pl-3">Products</div>
                    </router-link>
            ...
            <div class="flex flex-col flex-1 h-screen overflow-y-hidden">
                ...
                <!--    Right Bottom section DIV-->
                <div class="flex flex-col overflow-y-hidden flex-1">
                    <router-view class="pt-6 overflow-x-hidden"></router-view>
                </div>
